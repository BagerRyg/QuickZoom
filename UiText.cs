...
internal static class UiText
{
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ["Common.On"] = "On",
        ["Common.Off"] = "Off",
        ["Tray.ToggleMagnify"] = "Magnification",
        ...
        ["Tray.QuickSubtitle"] = "Fast controls for zoom, colors, and monitor behavior.",
        ...
        ["Settings.InputTitle"] = "Hotkeys and input",
    ...
    private static readonly Dictionary<string, string> Danish = new(StringComparer.Ordinal)
    {
        ["Common.On"] = "Til",
        ["Common.Off"] = "Fra",
        ["Tray.ToggleMagnify"] = "Forstorrelse",
        ...
        ["Tray.QuickSubtitle"] = "Hurtige kontroller til zoom, farver og skaermvalg.",
        ...
        ["Settings.InputTitle"] = "Genveje og input",
